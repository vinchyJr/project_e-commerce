...
const NintendoSwitch: React.FC = () => {
  const [jeuxNintendo, setJeuxNintendo] = useState<Jeu[]>([]);
  ...
  useEffect(() => {
    const fetchGames = async () => {
      try {
        ...
        setJeuxNintendo(games);
      } catch (error) {
        setError('Aucun jeu dans Nintendo Switch');
  ...
  return (
    <div className="bg-color-dark">
      ...
      <div className="container mx-auto p-4 pt-32">
        <h2 className="text-2xl font-bold text-white mb-4 text-center">Nintendo Switch Games</h2>
